...
def initMinimap():
    minimapStart = imagesearch("assets/minimap.png", 0.8)
    minimapEnd = imagesearch("assets/minimap-end.png", 0.8)
        ...
        while True:
            try:
                for wptImg in waypoints:
                    ...
                    wpt = imagesearcharea(wptImg, miniMapPos[0], miniMapPos[1], miniMapPos[2], miniMapPos[3], 0.7)
                    if wpt[0] is not -1:
